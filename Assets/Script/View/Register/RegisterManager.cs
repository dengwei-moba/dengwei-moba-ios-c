...
public class RegisterManager : ViewBase
{
   ...
   "毋丘","贺兰","綦毋","屋庐","独孤","南郭","北宫","王孙","羽", "芳","月", "若", "叱吒","魔","幽","吕","仙"};
    ...
    public override void Awake()
    {
		...
		mRandomNameBtn = canvasTrans.Find("RandomNameBtn").GetComponent<Button>();
		mRandomNameBtn.onClick.AddListener(OnRandomName);
		OnRandomName();
    }
