...
namespace TrueSync {
    ...
    public sealed class TSMath {
        ...
        **/
        ...
        /// 限制:限制value的值在min和max之间， 如果value小于min，返回min。 如果value大于max，返回max，否则返回value
        /// </summary>
        ...
        /// DV 限制0~1:限制value在0,1之间并返回value。如果value小于0，返回0。如果value大于1,返回1，否则返回value 。
        /// </summary>
        /// <param name="value">The value to clamp.</param>
        /// <returns>The clamped value.</returns>
        ...
        /// <summary>
        /// DV 反插值:计算两个值之间的Lerp参数。也就是value在from和to之间的比例值。
        /// </summary>
        ...
        /// <summary>
        /// DV 和lerp类似，在最小和最大值之间的插值，并在限制处渐入渐出。
        /// </summary>
        ...
        /// <summary>
        /// DV 重复:循环数值t，0到length之间。t值永远不会大于length的值，也永远不会小于0。
        /// </summary>
        ...
        /// <summary>
        /// DV 移动角:像MoveTowards,但是当它们环绕360度确保插值正确。
