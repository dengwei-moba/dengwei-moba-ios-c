...
namespace TrueSync
{
    ...
    public struct TSVector
    {
        ...
        /// <summary>
        /// A vector with components (1,0,0);也就是向x轴。
        /// </summary>
        public static readonly TSVector right;
        /// <summary>
        /// A vector with components (0,1,0);也就是向y轴。
        /// </summary>
        ...
        /// <summary>
        /// A vector with components (0,0,1);也就是向z轴。
        /// </summary>
        ...
        public override string ToString() {
            return string.Format("({0:f8}, {1:f8}, {2:f8})", x.AsFloat(), y.AsFloat(), z.AsFloat());
        }
        #endregion
        ...
        /// 返回被投影到onNormal的vector。如果onNormal接近0，返回 0 vector。
        /// </summary>
