...
namespace TrueSync.Physics3D {
    ...
    /// DV 在碰撞发生射线时给出信息的部分。 hit点的计算是：rayStart+摩擦*方向 
    ...
    public abstract class CollisionSystem
    {
        ...
        /// 通过场景发送一个光线（由开始和方向确定）（所有物体被添加）。
        /// 注意：出于性能的原因，地形和三角剖分形状不受射线检查（射线是无限长的）。
        /// 他们检查对开始在射线原点,结束在 射线原点+射线方向的段。
        /// </summary>
